...
def replace_background(
    ...
    with torch.no_grad():
        ...
        final_positive_prompt = f"  {positive_prompt}"
        ...
        cleaned_images =  [
            simple_lama(generated_image, dilated_mask.convert('L'))
        ...
        composited_images = [
            ...
            ) for generated_image in cleaned_images
        ]
        pbar.update(1)
        pbar.close()
